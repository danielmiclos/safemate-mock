                ...
                <div className='flex flex-wrap justify-between -mx-4'>
                  <div className='w-full lg:w-auto px-4 mb-5 lg:mb-0'>
                    ...
                    <p className='text-xs leading-5 text-gray-300'>
                      Cadastro taxonômico para os formulários dos clientes
                    </p>
                  </div>
              ...
              <div className='pt-6 pb-8 bg-gray-500 rounded-xl'>
                <div className='px-6'>
                  <div className='sm:flex mb-6 items-center justify-between'>
                    <div className='relative w-full h-14 max-w-xs py-4 px-3 mb-5 sm:mb-0 border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg'>
                      <span className='absolute bottom-full left-0 ml-3 -mb-1 transform translate-y-0.5 text-xs font-semibold text-gray-100 px-1 bg-gray-500'>
                        Search
                      </span>
                      <div className='flex items-center'>
                        ...
                        <input
                          className='block w-full ml-2 outline-none bg-transparent text-sm text-gray-100 font-medium'
                          id='messagesInput1-1'
                    ...
                    <button className='inline-flex h-14 py-1 px-4 items-center bg-gray-600 hover:bg-gray-700 rounded-lg transition duration-200'>
                      <svg
                        width={14}
                        height={14}
                        viewBox='0 0 14 14'
                      ...
                      >
                        <path
                          d='M11.6668 0.333374H2.3335C1.80306 0.333374 1.29436 0.544088 0.919283 0.91916C0.54421 1.29423 0.333496 1.80294 0.333496 2.33337V3.11337C0.333401 3.38867 0.39014 3.66102 0.500163 3.91337V3.95337C0.594349 4.16735 0.727758 4.36181 0.893496 4.52671L5.00016 8.60671V13C4.99994 13.1133 5.02859 13.2248 5.08341 13.324C5.13823 13.4231 5.21742 13.5067 5.3135 13.5667C5.41959 13.6325 5.54201 13.6671 5.66683 13.6667C5.77119 13.6661 5.87395 13.641 5.96683 13.5934L8.6335 12.26C8.74344 12.2046 8.83589 12.1199 8.90061 12.0152C8.96533 11.9104 8.99979 11.7898 9.00016 11.6667V8.60671L13.0802 4.52671C13.2459 4.36181 13.3793 4.16735 13.4735 3.95337V3.91337C13.5927 3.66299 13.6585 3.39056 13.6668 3.11337V2.33337C13.6668 1.80294 13.4561 1.29423 13.081 0.91916C12.706 0.544088 12.1973 0.333374 11.6668 0.333374ZM7.86016 7.86004C7.79837 7.92233 7.74949 7.99621 7.71632 8.07744C7.68314 8.15866 7.66632 8.24564 7.66683 8.33337V11.2534L6.3335 11.92V8.33337C6.334 8.24564 6.31719 8.15866 6.28401 8.07744C6.25083 7.99621 6.20195 7.92233 6.14016 7.86004L2.60683 4.33337H11.3935L7.86016 7.86004ZM12.3335 3.00004H1.66683V2.33337C1.66683 2.15656 1.73707 1.98699 1.86209 1.86197C1.98712 1.73695 2.15669 1.66671 2.3335 1.66671H11.6668C11.8436 1.66671 12.0132 1.73695 12.1382 1.86197C12.2633 1.98699 12.3335 2.15656 12.3335 2.33337V3.00004Z'
                          fill='#3D485B'
                        />
                      </svg>
                      <span className='ml-1 text-sm text-gray-200 font-semibold'>
                        Filters
                      </span>
                    </button>
                  </div>
                    ...
                    <table className='w-full min-w-max'>
                      <thead>
                        <tr className='text-left'>
                          <th className='p-0'>
                            <div className='flex h-11 items-center py-3 px-6 rounded-l-xl bg-gray-600'>
                              <input type='checkbox' defaultValue='' id='' />
                              <span className='ml-3 text-xs text-gray-300 font-semibold'>
                                TÏTULO
                              </span>
                            </div>
                          </th>
                          <th className='p-0'>
                            <div className='flex items-center h-11 px-6 bg-gray-600'>
                          ...
                          <th className='p-0'>
                            <div className='flex items-center h-11 px-6 rounded-r-xl bg-gray-600'>
                              <span className='text-xs text-gray-300 font-semibold'>
                                CLIENTE
                              </span>
                            </div>
                          ...
                          <td className='p-0'>
                            <div className='flex items-center h-16 px-6'>
                              <div className='flex h-full items-center'>
                                <input type='checkbox' defaultValue='' id='' />
                                <img
                                  className='w-8 h-8 ml-4 mr-3 rounded-md object-cover'
                                  src='trizzle-assets/images/shoe-white-table.png'
                                  alt=''
                                />
                                <span className='text-sm font-medium text-gray-100'>
                                  Kappa training shoes
                                </span>
                              </div>
                            </div>
                          </td>
                ...
                <div className='flex flex-wrap items-center px-6 pt-8 border-t border-gray-400'>
                  <div className='w-full sm:w-auto mb-4 sm:mb-0 mr-auto'>
                    <div className='flex items-center'>
                      <button className='flex mr-2 items-center justify-center h-6 w-11 bg-gray-600 rounded-full'>
                  ...
                  <div className='w-full sm:w-auto mb-6 sm:mb-0'>
                    <div className='flex items-center justify-end'>
                      <a
                        className='inline-flex items-center justify-center h-8 w-12 p-1 mr-3 text-xs text-gray-400 font-semibold bg-gray-600 hover:bg-gray-700 rounded-lg transition duration-200'
                        href='#'
                      >
                        <svg
                          width={6}
                      ...
                      <a
                        className='inline-flex items-center justify-center h-8 w-12 p-1 text-xs text-blue-50 font-semibold bg-blue-500 hover:bg-blue-600 rounded-lg transition duration-200'
                        href='#'
                      >
                        <svg
                          width={6}
